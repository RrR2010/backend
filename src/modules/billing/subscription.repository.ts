...
class SubscriptionMapper {
  static toDomain(prismaSubscription: PrismaSubscription): Subscription {
    return Subscription.rehydrate({
      ...
      pendingPlanType:
        (prismaSubscription.pendingPlanType as PlanType) ?? null,
      pendingEffectiveFrom:
        prismaSubscription.pendingEffectiveFrom ?? null,
      pendingNewAmount: prismaSubscription.pendingNewAmount ?? null,
  ...
  static toPersistence(
    ...
    return {
      ...
      pendingPlanType: subscription.pendingPlanType ?? null,
      pendingEffectiveFrom: subscription.pendingEffectiveFrom ?? null,
      pendingNewAmount: subscription.pendingNewAmount ?? null,

...
import { Claim_TENotFoundError } from './claim-te.errors'
import { UserScope } from '@users/user.types'
import type { RequestContext } from '@authorization/authorization.types'

describe('Claim_TEService', () => {
  let service: Claim_TEService
  let repository: any
  ...
  function createEntity(overrides: Record<string, any> = {}): Claim_TE {
  ...
  beforeEach(() => {
    ...
    service = new Claim_TEService(repository)
  })
  ...
  describe('findById', () => {
    ...
    it('should throw Claim_TENotFoundError when not found', async () => {
  ...
  describe('delete', () => {
    ...
    it('should throw Claim_TENotFoundError when entity not found', async () => {
      repository.findById.mockResolvedValue(null)

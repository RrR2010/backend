...
import { CommercialLine_TENotFoundError } from './commercial-line-te.errors'
import { UserScope } from '@users/user.types'
import type { RequestContext } from '@authorization/authorization.types'

describe('CommercialLine_TEService', () => {
  let service: CommercialLine_TEService
  let repository: any
  ...
  function createEntity(overrides: Record<string, any> = {}): CommercialLine_TE {
  ...
  beforeEach(() => {
    ...
    service = new CommercialLine_TEService(repository)
  })
  ...
  describe('findById', () => {
    ...
    it('should throw CommercialLine_TENotFoundError when not found', async () => {
  ...
  describe('delete', () => {
    ...
    it('should throw CommercialLine_TENotFoundError when entity not found', async () => {
      repository.findById.mockResolvedValue(null)

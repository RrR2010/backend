...
import { ProductFamily_TENotFoundError } from './product-family-te.errors'
import { UserScope } from '@users/user.types'
import type { RequestContext } from '@authorization/authorization.types'

describe('ProductFamily_TEService', () => {
  let service: ProductFamily_TEService
  let repository: any
  ...
  function createEntity(overrides: Record<string, any> = {}): ProductFamily_TE {
  ...
  beforeEach(() => {
    ...
    service = new ProductFamily_TEService(repository)
  })
  ...
  describe('findById', () => {
    ...
    it('should throw ProductFamily_TENotFoundError when not found', async () => {
  ...
  describe('delete', () => {
    ...
    it('should throw ProductFamily_TENotFoundError when entity not found', async () => {
      repository.findById.mockResolvedValue(null)

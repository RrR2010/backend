...
describe('CompanyService', () => {
  ...
  function createEntity(overrides: Record<string, any> = {}): Company_TE {
  ...
  describe('findById', () => {
    ...
    it('should throw CompanyNotFoundError when not found', async () => {
  ...
  describe('delete', () => {
    ...
    it('should throw CompanyNotFoundError when entity not found', async () => {
      repository.findById.mockResolvedValue(null)

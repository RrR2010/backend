...
import { CompanyRepository, CompanyFilter } from '@ingredients/company.repository'
import { Company, CreateCompanyProps } from '@ingredients/company.entity'
import { CompanyNotFoundError, CompanyAlreadyExistsError } from '@ingredients/company.errors'
...
export class CompanyService {
  ...
  async create(props: CreateCompanyProps, ctx: RequestContext): Promise<Company> {

...
import { IngredientNutrient, CreateIngredientNutrientProps } from '@ingredients/ingredient-nutrient.entity'
...
export class IngredientNutrientService {
  ...
  async create(props: CreateIngredientNutrientProps, ctx: RequestContext): Promise<IngredientNutrient> {

...
class PrismaTenantRegistrationMapper {
  static toDomain(
    ...
    return TenantRegistration.rehydrate({
      ...
      provisionedAddressId: prismaRegistration.provisionedAddressId,
      provisionedPhoneId: prismaRegistration.provisionedPhoneId,
  ...
  static toPersistence(
    ...
    return {
      ...
      provisionedAddressId: registration.provisionedAddressId,
      provisionedPhoneId: registration.provisionedPhoneId,
